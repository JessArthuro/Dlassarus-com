...
class Ventas_model extends CI_Model {
	...
	public function getVentas(){
		$this->db->select("v.*,tc.nombre as tipocomprobante");
	...
	public function getDetalle($id){
		$this->db->select("dt.*,p.codigo, p.marca");
	...
	public function getProductos($valor){
		$this->db->select("id, codigo,marca as label,precio,stock");
